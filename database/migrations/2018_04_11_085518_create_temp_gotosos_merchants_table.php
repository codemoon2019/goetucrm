...
class CreateTempGotososMerchantsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('temp_gotosos_merchants', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('temp_gotosos_merchants');
    }
}
