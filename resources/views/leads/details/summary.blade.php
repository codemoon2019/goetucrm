        ...
        <section class="content container-fluid">
            ...
            <div class="nav-tabs-custom">
                <ul class="tabs-rectangular">
                    <li class="active"><a href="{{ url('leads/details/summary/'.$partner_id) }}">Summary</a></li>
                    @if($isInternal)
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <p class="text-muted">
                                                        @foreach ($upline as $item)
                                                            @if($assigned_id < 0)
                                                                @if($item->parent_id == $partner_info[0]->parent_id) {{ $item->partner_id_reference }} - {{ $item->company_name }} - {{ $item->upline_partner }} @endif
                                                            @else
                                                                @if($assigned_id == $item->parent_id) {{ $item->partner_id_reference }} - {{ $item->company_name }} - {{ $item->upline_partner }} @if($assigned_id == $item->parent_id) (Pending) @endif @endif
                                                            @endif
                                                        @endforeach
