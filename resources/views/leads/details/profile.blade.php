        ...
        <section class="content container-fluid">
            ...
            <div class="nav-tabs-custom">
                <ul class="tabs-rectangular">
                    ...
                    @if($isInternal)
                    <li class="active"><a href="{{ url('leads/details/profile/'.$partner_id) }}">Profile</a></li>
                ...
                @if($isInternal)
                    ...
                    <form role="form" name="frmUpdateLead" id="frmUpdateLead">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="country" id="country" class="form-control s2-country">
                                         @foreach($country as $item)
                                            <option value="{{ $item->name }}" data-code="{{ $item->iso_code_2 }}" @if($partner_info[0]->country_name == $item->name) selected="selected" @endif>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="txtEmailLead">Email(must be valid):<span class="required">@if(!isset($partner_info[0]->mobile_number)) * @endif</span></label>
                                    <input type="text" class="form-control" name="txtEmailLead" id="txtEmailLead" value="{{$partner_info[0]->email}}" placeholder="Enter Email" onblur="validateData('users','email_address',this,{{$partner_id}},'true','reference_', 'Email address already been used by other users'); validateData('partner_contacts','email',this,{{$partner_id}},'false','partner_', 'Email address already been used by other partners');" />
                                    <span id="txtEmailLead-error" style="color:red;"><small></small></span>
                                </div>
                            </div>
                        </div>
                        ...
                        @if($canConvert != 0)
                            ...
                            <button type="button" class="btn btn-success tabbtn" id="btnConvertToProspect" name="btnConvertToProspect">
                                Convert to Prospect
                            </button>
                        @endif
                        @if($canEdit != 0)
