        ...
        <section class="content container-fluid">
            ...
            <div class="nav-tabs-custom">
                <ul class="tabs-rectangular">
                    ...
                    <li class="active"><a href="{{ url('leads/details/interested/'.$partner_id) }}">Interested Products</a></li>
    ...
    <div id="modalInterestedProductSelection" class="modal" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form role="form" name="frmAddInterestedProducts" id="frmAddInterestedProductsLeads"> 
