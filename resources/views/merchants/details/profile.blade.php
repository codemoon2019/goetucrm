    ...
    <section class="content container-fluid">
        ...
        <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs ui-sortable-handle secondary-tabs">
                <li id="summary"><a href="#overview" id="ovview" data-toggle="tab" aria-expanded="true">Summary</a></li>
                @if($isInternal)
            ...
            <div class="tab-content no-padding">
                                                    ...
                                                    @if($merchant->parent_id > 0)
                                                        @foreach($upline_partners as $up)
                                                            @if($merchant->parent_id == $up->parent_id)
                                                                {{ $up->partner_id_reference }} - {{ $up->upline_partner }}
                                                            @endif
                                                        @endforeach
                ...
                <div class="tab-pane active" id="business-info">
                    <form id="frmMerchantInfo" name="frmMerchantInfo" method="post" enctype="multipart/form-data"
                        action="/merchants/updateinfo/{{$id}}">
                        {{ csrf_field() }}
                        <div class="row mb-plus-20">
                            ...
                            <div class="col-md-3">
                                <div class="circle circle-update">
                                    <img class="profile-pic" id="partnerImg" src="{{ isset($merchant->connectedUser->image) && $merchant->connectedUser->image != '' ? $merchant->connectedUser->image : '' }}" width="100%">
                                </div>
                            ...
                            <div class="col-md-9 mt-5">
                                <div class="row">
                                    @if($merchant->merchant_status_id == App\Models\MerchantStatus::LIVE_ID || $merchant->merchant_status_id == App\Models\MerchantStatus::BOARDED_ID)
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Status:</label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Parent:</label>
                                            <select class="form-control select2" id="txtUplineId" name="txtUplineId"  @if($merchant->parent_id == -1 || $merchant->parent_id == "") @else disabled @endif>
                                                @foreach($upline_partners as $up)
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="" id="" value="{{$merchant->creator->first_name}} {{$merchant->creator->last_name}} ({{$merchant->create_by}})"
                                                readonly>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12 sm-col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="txtBusinessName" name="txtBusinessName"
                                                value="{{$merchant->partner_company->company_name}}" placeholder="Enter Business Name" maxlength="50"> 
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12 sm-col">
                                        <div class="form-group">
                                            <label>Website / Url: </label>
                                                <input type="text" id="url" name="url" class="form-control" value="{{ $merchant->merchant_url }}" maxlength="50">
                                        </div>
                                    </div>
        
                                    <div class="col-lg-4 col-md-4s col-sm-12 sm-col" style="display:none;">
                                        <div class="form-group">
                                            <label>Credit Card Refence ID: </label>
                                            <input type="text" class="form-control" id="txtCreditCardReferenceId" value="{{ $merchant->credit_card_reference_id }}" 
                                            name="txtCreditCardReferenceId" placeholder="Enter Credit Card Refence ID" maxlength="50">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 sm-col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="txtLegalBusinessName" name="txtLegalBusinessName"
                                        value="{{$merchant->partner_company->business_name}}" placeholder="Enter Legal Business Name" maxlength="50">
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="currentProcessor" id="currentProccessor" class="form-control select2" style="width:100%">
                                        ...
                                        @foreach ($paymentProcessor as $item)
                                            <option value="{{$item->name}}" {{ $merchant->merchant_processor == $item->name ? "selected" : "" }}>{{$item->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 sm-col">
                                <div class="form-group">
                                    <label>Date when business was opened: </label>
                                    <input type="text" class="form-control integer-only" name="txtBusinessDate" id="txtBusinessDate" value="{{ $merchant->partner_company->business_date }}" placeholder="mm/yyyy" />
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 sm-col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="txtPricingType" value="{{$merchant->pricing_type}}" name="txtPricingType"
                                        placeholder="Enter Pricing Type" maxlength="50">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="txtBankName" id="txtBankName" placeholder="Bank Name" value="{{ $merchant->bank_name }}" maxlength="50">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="txtBankAddress" id="txtBankAddress" placeholder="Bank Address" value="{{ $merchant->bank_address }}">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control integer-only" name="txtFrontEndMID" id="txtFrontEndMID" placeholder="Front End MID" value="{{ $merchant->front_end_mid }}" maxlength="50">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control integer-only" name="txtBackEndMID" id="txtBackEndMID" placeholder="Back End MID" value="{{ $merchant->back_end_mid }}" maxlength="50">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control integer-only" name="txtReportingMID" id="txtReportingMID" placeholder="Reporting MID" value="{{ $merchant->reporting_mid }}" maxlength="50">
                                </div>
                            </div>
                                ...
                                <div class="form-group pull-right">
                                    @if ($merchant->merchant_status_id == App\Models\MerchantStatus::BOARDING_ID || $merchant->merchant_status_id == App\Models\MerchantStatus::FOR_APPROVAL_ID)
                                        @hasAccess('merchant', 'decline merchant')
                                            <button type="button" class="btn btn-warning" onclick="declineMerchant({{$id}})">Decline Merchant</button>
                                        @endhasAccess
                                    @endif
                ...
                <div class="tab-pane" id="addresses">
                    <form id="frmMerchantAddress" name="frmMerchantAddress" method="post" enctype="multipart/form-data"
                        action="/merchants/updateaddress/{{$id}}">
                        {{ csrf_field() }}
...
<!--                                         <li id="" class="active"><a href="#DBA" data-toggle="tab" aria-expanded="false">DBA Address</a></li>
                                            ...
                                            <li id="ship_tab"><a href="#Mailing" data-toggle="tab" aria-expanded="false">Mailing Address</a></li>
                                    </ul>
                                </div>
                                                    ...
                                                    <select class="form-control s2-country"
                                                        ...
                                                        @foreach($country as $c)
                                                            <option value="{{ $c->name }}" data-abbr="{{ $c->iso_code_2 }}"
                                                                ...
                                                                @if($merchant->partner_company->country == $c->name) selected @endif>
                                                                {{ $c->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control s2-state"
                                                        ...
                                                        <option value="{{$s->abbr}}" @if($merchant->partner_company->state
                                                            == $s->abbr) selected @endif>{{$s->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="tab-pane" id="Billing">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Address: </label>
                                                    <input type="text" class="form-control" id="txtBillingAddress1" name="txtBillingAddress1"
                                                        value="{{$merchant->partner_billing->address OR ''}}" place></small></span>
                                                    <span id="txtBillingAddress1-error" style="color:red"><small></small></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="txtBillingAddress2" name="txtBillingAddress2"
                                                        value="{{$merchant->partner_billing->address2 OR ''}}" placeholder="Enter Address 2"></small></span>
                                                </div>
                                            </div>
                                                    ...
                                                    <select class="form-control s2-country"
                                                        ...
                                                        @foreach($country as $c)
                                                            <option value="{{ $c->name }}" data-abbr="{{ $c->iso_code_2 }}"
                                                                ...
                                                                @if($merchant->partner_billing->country == $c->name) selected @endif
                                                                @endif>
                                                                {{ $c->name }}
                                                            </option>
                                                        @endforeach
                                            ...
                                            <div class="col-md-6" id="bill_state_us" style="display: block;">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control s2-state"
                                                        style="width: 100%;" id="txtBillingStateUS" name="txtBillingStateUS" tabindex="-1"
                                                        aria-hidden="true" disabled>
                                                        @foreach($stateUS as $s)
                                                        <option value="{{$s->abbr}}" @if(isset($merchant->partner_billing->state)) @if($merchant->partner_billing->state
                                                            == $s->abbr) selected @endif @endif>{{$s->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {{-- <input type="text" class="form-control" id="txtShippingCity" name="txtShippingCity"
                                                        value="{{$merchant->partner_billing->city OR ''}}" placeholder="Enter city"> --}}
                                                    <select name="txtBillingCity" id="txtBillingCity" class="form-control select2" disabled>
                                                            <option value="{{ $merchant->partner_billing->city OR '' }}" selected>{{ $merchant->partner_billing->city OR ''}}</option>
                                                    </select>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="txtMailingAddress2" name="txtMailingAddress2"
                                                        value="{{$merchant->partner_mailing->address2 or ''}}" placeholder="Enter Address 2"></small></span>
                                                </div>
                                            </div>
                                                    ...
                                                    <select class="form-control s2-country"
                                                        ...
                                                        @foreach($country as $c)
                                                            <option value="{{ $c->name }}" data-abbr="{{ $c->iso_code_2 }}"
                                                                ...
                                                                @if($merchant->partner_mailing->country == $c->name) selected @endif 
                                                                @endif>
                                                                {{ $c->name }}
                                                            </option>
                                                        @endforeach
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="txtMailingCity" id="txtMailingCity" class="form-control select2" disabled>
                                                            <option value="{{ $merchant->partner_mailing->city OR ''}}" selected>{{ $merchant->partner_mailing->city OR ''}}</option>
                                                    </select>
                            ...
                            <div class="col-lg-4 col-md-12 sm-col">
                                <div class="tab-content" style="padding:10px;border: 1px solid #ddd;border-bottom-left-radius: 5px; border-bottom-right-radius: 5px;">
                                    ...
                                    <div class="form-group">
                                        <label>Phone Number2: <span class="required"></span></label>
                                        <div class="input-group">
                                            <div class="input-group-addon">
                                                <label for="BusinessPhone">1</label>
                                            </div>
                                            <input type="text" class="form-control number-only" id="txtPhoneNumber2"
                                                name="txtPhoneNumber2" placeholder="Enter Phone Number 2" value="{{$merchant->partner_company->nd_phone2}}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                        ...
                        <table class="table datatables table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($pc->mobile_number!="")
                                            {{$pc->country_code}}{{$pc->mobile_number}}
                                        @endif
                                    </td>
                                    <td>{{$pc->email}}</td>
                                     @if (auth()->user()->is_original_partner != 1)
                                    <td> @if($maskInfo) ***-**-{{ substr($pc->ssn,7,4) }} @else {{substr($pc->ssn,7,4)}} @endif @if($pc->ssn_verified == 0) <span class="badge badge-danger">unverified</span> @endif</td>
                                    @endif
                                    <td>@if($canEdit)<button type="button" onclick="editContact({{$pc->id}});" class="btn btn-default btn-sm">Edit</button>@endif</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
                            ...
                            <div class="box-body">
                                <div class="modal-body">
                                    <form id="frmComment{{$id}}" name="frmComment{{$id}}" method="post" enctype="multipart/form-data"
                                        action="/merchants/details/profile/addComment">
                                        {{ csrf_field() }}
                                    ...
                                    <div id="comment-list">
                                        <div class="comment discussion" id="comment{{$comment->comment_id}}">
                                            ...
                                            <form name="frmSubComment{{$comment->comment_id}}" id="frmSubComment{{$comment->comment_id}}"
                                                method="post" action="/merchants/details/profile/addSubComment">
                                                {{ csrf_field() }}
...
<div id="modalUploadAttachment" class="modal" role="dialog">
    <form role="form" name="frmRegisterAttachment" id="frmRegisterAttachment" method="post" enctype="multipart/form-data"
        action="{{ url("/merchants/upload_attachment") }}">
        {{ csrf_field() }}
...
<div class="modal fade" id="editContact" role="dialog">
    <div class="modal-dialog" role="document" style="max-width:800px">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="frmContactInfo" name="frmContactInfo" method="post" enctype="multipart/form-data" action="/merchants/updatecontact/{{$id}}">
                    {{ csrf_field() }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control alpha" id="txtTitle" name="txtTitle" maxlength="50">
                                </div>
                            </div>
                            @if (auth()->user()->is_original_partner != 1)
                            <div class="col-sm-4">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control alphanum" id="txtIssuedID" name="txtIssuedID" maxlength="50">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control number-only" id="txtContactMobile" name="txtContactMobile">
                                                        </div>
                            ...
                            <div class="
                                                            ...
                                                            <div class="col-sm-4 sm-col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="txtContactEmail" name="txtContactEmail" maxlength="50">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="frmPaymentGateway" name="frmPaymentGateway" method="post" enctype="multipart/form-data"
                        action="/merchants/updatepaymentgateway/{{$id}}">
                        {{ csrf_field() }}
