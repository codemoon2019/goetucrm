                        ...
                        <div class="timeline-item">
                            <div class="timeline-body">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" id="txtLegalBusinessName" name="txtLegalBusinessName"
                                                    value="" placeholder="Enter Legal Business Name" maxlength="50">
                                            </div>
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" id="txtBusinessName" name="txtBusinessName"
                                                    value="" placeholder="Enter Business Name" maxlength="50">
                                ...
                                <div class="row" style="display: none;">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="txtTaxIdNumber" value="" name="txtTaxIdNumber"
                                            placeholder="Enter Tax ID Number" maxlength="50">
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="txtCreditCardReferenceId" value="" name="txtCreditCardReferenceId"
                                            placeholder="Enter Credit Card Refence ID" maxlength="50">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-3 align-self-end offset-md-3">
                                    ...
                                    <div class="form-group col-md-2">
                                        <label for="txtBusinessDate">Business Start Date:</label>
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <input type="text" id="url" name="url" class="form-control" placeholder="Enter Website" maxlength="50">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 align-self-end offset-md-3">
                            ...
                            <div class="timeline-body">
                                <div class="row">
                                    <div class="form-group col-sm-3">
                                        ...
                                        <input type="text" class="form-control integer-only" name="txtFrontEndMID" id="txtFrontEndMID" placeholder="Front End MID " maxlength="50">
                                    </div>
                                    <div class="form-group col-sm-3">
                                        <label>Back End MID:<span class="required"></span></label>
                                        <input type="text" class="form-control integer-only" name="txtBackEndMID" id="txtBackEndMID" placeholder="Back End MID" maxlength="50">
                                    </div>
                                    <div class="form-group col-sm-3">
                                        <label>Reporting MID:<span class="required"></span></label>
                                        <input type="text" class="form-control integer-only" name="txtReportingMID" id="txtReportingMID" placeholder="Reporting MID" value="" maxlength="50">
                                    </div>
                                </div>
