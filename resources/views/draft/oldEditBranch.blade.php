                                        ...
                                        <div class="tab-content" style="padding:10px;border-left: 1px solid #ddd;border-bottom: 1px solid #ddd;border-right: 1px solid #ddd;border-bottom-left-radius: 5px; border-bottom-right-radius: 5px;">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" id="txtZip" name="txtZip"
                                                            placeholder="Enter zip" value="{{ $draft->business_zip }}">
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control s2-country"
                                                                ...
                                                                @foreach($countries as $c)
                                                                    <option value="{{ $c->name }}" data-abbr="{{ $c->iso_code_2 }}"
                                                                        data-code="{{ $c->country_calling_code }}" 
                                                                        {{ $draft->shipping_country == $c->name ? "selected" : ""  }}>
                                                                        {{ $c->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" id="txtShippingZip" name="txtShippingZip"
                                                            placeholder="Enter zip" value="{{ $draft->shipping_zip }}">
                                                    ...
                                                    <div class="col-md-6" id="state_ship_us" style="display: block;">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control s2-state"
                                                                ...
                                                                aria-hidden="true" disabled>
                                                                @foreach($states as $s)
                                                                <option value="{{$s->abbr}}" data-code="{{ $s->id }}" {{$draft->shipping_state == $s->abbr ? "selected" : ""  }}>{{$s->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="txtShippingCity" id="txtShippingCity" class="form-control select2" disabled>
                                                                @foreach ($initialCities as $c)
                                                                    <option value="{{ $c->city }}" {{ $draft->shipping_city == $c->city ? "selected" : "" }}>{{ $c->city }}</option>
                                                                @endforeach
                                                            </select>
                                            ...
                                            <div class="tab-pane" id="Mailing">
                                                <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control s2-country"
                                                                ...
                                                                @foreach($countries as $c)
                                                                    <option value="{{ $c->name }}" data-abbr="{{ $c->iso_code_2 }}"
                                                                        data-code="{{ $c->country_calling_code }}" 
                                                                        {{ $draft->mailing_country == $c->name ? "selected" : ""  }}>
                                                                        {{ $c->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-md-6">
                                                        <label for="zip">Zip:</label>
                                                        <input type="text" class="form-control" id="txtMailingZip" name="txtMailingZip" placeholder="Enter zip" value="{{ $draft->mailing_zip }}" >
