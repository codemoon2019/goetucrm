...
<!--                                     <div class="col-lg-6 col-md-6 col-sm-12 sm-col">
                                                    ...
                                                    <div class="col-md-6" id="state_mail_ph" style="display:none;">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control"
                                                                ...
                                                                aria-hidden="true">
                                                                @foreach($statePH as $s)
                                                                <option value="{{$s->abbr}}" data-code="{{$s->id}}">{{$s->abbr}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                            ...
                            <div class="col-md-12 sm-col pull-right ta-right">
                                @if($canSaveAsDraft)
                                    <button type="button" class="btn btn-success tabbtn btnSaveAsDraftBranch" id="btnSaveAsDraftBranch" name="btnSaveAsDraft">
                                        Save as Draft
                                    </button>
                                    &nbsp;
                                @endif
