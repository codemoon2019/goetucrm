...
<div id="modalViewRecurring" class="modal" role="dialog">
    <div class="modal-dialog" style="max-width:800px">
        <form id="frmRecurringBranchEdit" name="frmRecurringBranchEdit" method="post" enctype="multipart/form-data" action="/merchants/branch/update_recurring_invoice">
            {{ csrf_field() }}
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    @if($canCharge)
                    <input type="button" class="btn btn-primary" value="Update" onclick="updateRecurringBranch();">
                    <input type="button" class="btn btn-success" id="btnResume" value="Resume Billing" onclick="resumeRecurringBranch();">
                    <input type="button" class="btn btn-danger" id="btnStop" value="Stop Billing" onclick="stopRecurringBranch();">
                    @endif
                    <button type="button" class="btn btn-secondary btn-close" data-dismiss="modal">Close</button>
                </div>
            </div>
