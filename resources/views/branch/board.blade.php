    ...
    <div class="chrome-tabs">
      <ul class="nav nav-tabs ui-sortable-handle">
        ...
        @hasAccess('branch', 'view branch approval')
          <li>
            <a href="/merchants/approve_branch">
            ...
            <div class="col-md-12">
              <div class="row">
                ...
                <div class="form-group col-sm-3" id="divSearchText">
                  <input type="text" class="form-control" id="txtSearchValue" name="txtSearchValue" placeholder="Search Branch...">
                </div>
