        ...
        <section class="content container-fluid">
            ...
            <div class="nav-tabs-custom">
                <ul class="tabs-rectangular">
                    ...
                    <li class="active"><a href="{{ url('prospects/details/contact/'.$partner_id) }}">Contact</a></li>
                ...
                @if($isInternal)
                    ...
                    <form role="form" name="frmUpdateContact" id="frmUpdateContact">
                        ...
                        <input type="hidden" id="txtEmailPros" name="txtEmailPros" value="{{$partner_info[0]->email}}">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <label class="input-group-addon"  for="businessPhone1">2</label>
