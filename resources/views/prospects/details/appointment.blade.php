    ...
    <div class="content-wrapper">
        ...
        <section class="content container-fluid">
            <div class="col-md-12 secondary-header">
                ...
                <a href="{{ url("prospects/") }}" class="btn btn-default pull-right mt-minus-40">< Back to Prospects</a><br>
            ...
            <div class="nav-tabs-custom">
                <ul class="tabs-rectangular">
                    ...
                    <li class="active"><a href="{{ url('prospects/details/appointment/'.$partner_id) }}">Appointment</a></li>
                    @endif
                </ul>
                <!-- Tabs within a box -->
...
@section('script')
    ...
    <script src="{{ config("app.cdn") . "/js/prospects/calendar.js" . "?v=" . config("app.version") }}"></script>
@endsection
