    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Add Prospects </li>
            </ol>
                ...
                <div class="tab-content no-padding">
                    <div class="tab-pane active" id="business-info">
                        <form role="form" name="frmAddLead" id="frmAddLead">
                            <div class="row">
                                ...
                                <input type="hidden"  name="txtPartnerTypeId" id="txtPartnerTypeId" value="8">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 {{ $systemUser ? '' : 'hidden' }}">
                                    <div class="form-group">
                                        ...
                                        @php
                                        if(auth()->user()->is_original_partner != 1) { @endphp
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select name="assignee" id="assignee" class="form-control select2" style="width:100%">
                                                    <!-- <option>Wilson Chen - C10001</option> -->
                                                    @if(isset($upline))
                                                        @foreach ($upline_partner_type as $item)
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label for="txtEmailPros">Email(must be valid):<span class="required"></span></label>
                                        <input type="text" class="form-control" name="txtEmailPros" id="txtEmailPros" value="" placeholder="Enter Email"/>
                                        <span id="txtEmailPros-error" style="color:red;"><small></small></span>
                                        <span class="error" style="color:orange;"><small>Note: If left blank, Prospect must have at least the Contact Person's Mobile Number.</small></span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane" id="contact-person">
                        <div class="row">
                            ...
                            <!-- <div class="col-md-6">
                                <div class="form-group">
                                    <label class="txtEmail2Pros">2nd Email:</label>
                                    <input type="text" class="form-control" name="txtEmail2Pros" id="txtEmail2Pros" value="" placeholder="Enter Email">
                                </div>
                            </div> -->
                        </div>
                        <div class="form-group">
