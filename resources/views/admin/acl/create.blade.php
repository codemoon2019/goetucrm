    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ url("admin/acl") }}">Permissions</a></li>
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content no-padding">
                    <div class="tab-pane active">     
					    ...
					    <form role="form" action="{{ url("/admin/acl") }}"  enctype="multipart/form-data" method="POST">
						{{ csrf_field() }}
                        <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="name" value="" placeholder="Enter Permission Name"/>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="resource">Resource:<span class="required">*</span></label>
                                <input type="text" class="form-control" name="resource" id="resource" value="" placeholder="Enter Resouce URL Access"/>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
