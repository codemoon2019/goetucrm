                    ...
                    <div class="tab-pane active">     
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="name" value="{{$resource->description}}" placeholder="Enter Permission Name" disabled />
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="resource">Resource:<span class="required">*</span></label>
                                <input type="text" class="form-control" name="resource" id="resource" value="{{$resource->resource}}" placeholder="Enter Resouce URL Access" disabled/>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="module_category">Module Category:</label>
                                <select name="module_category" id="module_category" class="form-control" disabled="">
         				...
         				<div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="module_access" id="module_access" class="form-control" disabled="">
