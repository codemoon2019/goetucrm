        ...
        <div class="content">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">{{ __("model.company.edit") }}</h3>
                ...
                <form role="form" action="{{ url("/admin/company/". $company->id) }}" enctype="multipart/form-data" method="POST">
                    {{ csrf_field() }}
                    {{ method_field("PUT") }}
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group has-feedback {{ $errors->has("powered_by_link") ? "has-error" : "" }}">
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ old("powered_by_link") ?: $company->powered_by_link }}"
                                    >
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <!-- Logo -->
                                <div class="fileinput text-center {{ !empty($company->logo_path) ? "fileinput-exists " : "fileinput-new " }}"
                                ...
                                >
                                    ...
                                    <div class="fileinput-preview fileinput-exists thumbnail img-raised">
                                        @if(!empty($company->logo_path))
                                            <img src="{{ \Illuminate\Support\Facades\Storage::url($company->logo_path) }}" />
                                            <input type="hidden"
