...
<body class="body">
    <div class="inside-content">
        <table>
            <tr>
                <td>
                    <h3 class="space" style="display: initial;">Ticket #{{ $ticketHeader->id }} is deleted</h3><br>
    ...
    <table>
        ...
        <tr>
            ...
            <td class="color-disable space">{{ $ticketHeader->department == -1 ? 'N/A' : $ticketHeader->userType->name }}</td>
        </tr>
        <tr>
