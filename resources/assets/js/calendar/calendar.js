$(document).ready(function () {
    ...
    $.ajax({
        type: 'GET',
        url: '/calendar/getCalendarProfiles',
        data: data = null,
        dataType: 'json',
    ...
    function inputForm(select, status = 'A', organizer = "", partner = "") {
        ...
        if (!(partner == "" || partner == null)) {
            lead = '<label class="form-group">Lead/Prospect : ' + partner + '</label><br>';
        }
    ...
    function addCalEvent(actStatus) {
        ...
        $.ajax({
            url: '/calendar/saveCalendarActivity', //"?action=save_calendar_activity", // Url to which the request is send
    ...
    function updateCalEvent(actStatus, reminderOnly = false) {
        ...
        if (!reminderOnly) {
            ...
            $.ajax({
                url: '/calendar/saveCalendarReminder', //"?action=save_calendar_reminder", // Url to which the request is send
                type: "POST", // Type of request to be send, called as method
                data: new FormData(form), // Data sent to server, a set of key/value pairs (i.e. form fields and values)
                dataType: 'json',
                contentType: false, // The content type used when sending data to the server.
    ...
    function loadCalendarActivities() {
        ...
        $.ajax({
            type: 'GET',
            url: '/calendar/getCalendarActivities',
            data: null,
            dataType: 'json',
            success: function (data) {
