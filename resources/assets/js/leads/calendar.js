$(document).ready(function () {
    ...
    $.ajax({
        type: 'GET',
        url: '/leads/details/appointment/getCalendarProfiles',
        data: data = null,
        dataType: 'json',
    ...
    function inputForm(select, status = 'A', organizer = "", partner = "") {
        ...
        if (!(partner == "" || partner == null)) {
            lead = '<label class="form-group">Lead : ' + partner + '</label><br>';
        }
    ...
    function addCalEvent(actStatus) {
        ...
        $.ajax({
            url: '/leads/details/appointment/saveCalendarActivity', //"?action=save_calendar_activity", // Url to which the request is send
    ...
    function updateCalEvent(actStatus, reminderOnly = false) {
        ...
        if (!reminderOnly) {
            ...
            $.ajax({
                url: '/leads/details/appointment/saveCalendarReminder', //"?action=save_calendar_reminder", // Url to which the request is send
                type: "POST", // Type of request to be send, called as method
                data: new FormData(form), // Data sent to server, a set of key/value pairs (i.e. form fields and values)
                dataType: 'json',
                contentType: false, // The content type used when sending data to the server.
    ...
    function loadCalendarActivities() {
        ...
        $.ajax({
            type: 'GET',
            url: '/leads/details/appointment/getCalendarActivities',
            data: 'id=' + null,
            dataType: 'json',
            success: function (data) {
