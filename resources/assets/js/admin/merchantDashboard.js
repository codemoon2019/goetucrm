...
import Charts from './merchantCharts';
import ProductCharts from './merchantProductCharts';
import moment from 'moment';


class MerchantDashInvoice extends React.Component {
  constructor(props) {
    super(props);
  ...
  updateDash(from,to,filter = "") {
    ...
    let url  = '/company/merchant_dashbord_data/periodic_sales';
    const config = {
        headers: { 
      ...
      <div>
        ...
        <div className="row">
            <div className="col-lg-12 col-md-3 col-sm-4">                 
              <Charts data = {this.state.salesData} />
            </div>
        </div>
      </div>
...
ReactDOM.render(<MerchantDashInvoice />, document.getElementById('dashboard-body'));

class MerchantDashProduct extends React.Component {
  constructor(props) {
    super(props);
  ...
  updateDash(from,to) {
    ...
    let url  = '/company/merchant_dashbord_data/product_sales';
    const config = {
        headers: { 
            'content-type': 'multipart/form-data',
            'X-Requested-With' : 'XMLHttpRequest'
  ...
  render() {
    return (
      <div>
        ...
        <div className="row">
            <div className="col-lg-12 col-md-3 col-sm-4">                 
              <ProductCharts data = {this.state.salesData} />
            </div>
        </div>
      </div>
...
ReactDOM.render(<MerchantDashProduct />, document.getElementById('dashboard-body-product'));