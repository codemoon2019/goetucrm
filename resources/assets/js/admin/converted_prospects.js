...
import Charts from './convertedProspectsChart';
...
class PartnerDash extends React.Component {
  constructor(props) {
    ...
    this.updateDash(moment().add(-90, 'days'),moment());
  }
  ...
  updateDash(start,end) {
    ...
    let url  = '/company/partner_dashboard_data/converted_prospects';
    const config = {
        headers: { 
...
ReactDOM.render(<PartnerDash />, document.getElementById('dashboard-body-converted-prospects'));
