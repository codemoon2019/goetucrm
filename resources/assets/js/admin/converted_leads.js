...
import Charts from './convertedLeadsChart';
...
class PartnerDash extends React.Component {
  ...
  updateDash(start,end) {
    ...
    let url  = '/company/partner_dashboard_data/converted_leads';
    const config = {
        headers: { 
...
ReactDOM.render(<PartnerDash />, document.getElementById('dashboard-body-converted-leads'));
