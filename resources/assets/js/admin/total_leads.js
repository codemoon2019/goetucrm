...
import Charts from './totalLeadsChart';
...
class PartnerDash extends React.Component {
  ...
  updateDash(start,end) {
    ...
    let url  = '/company/partner_dashboard_data/total_leads';
    const config = {
        headers: { 
...
ReactDOM.render(<PartnerDash />, document.getElementById('dashboard-body-total-leads'));
