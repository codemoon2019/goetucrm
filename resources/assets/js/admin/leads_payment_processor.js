...
import PieCharts from './leadPaymentProcessorChart';
...
class PartnerDash extends React.Component {
  ...
  updateDash(start,end) {
    ...
    let url  = '/company/partner_dashboard_data/payment_processor';
    const config = {
        headers: { 
...
ReactDOM.render(<PartnerDash />, document.getElementById('dashboard-body-leads-payment-processor'));
